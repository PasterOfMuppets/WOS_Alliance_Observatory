...
1. **Restore legion info in player history payload**  
...
2. **Keep `/api/events/foundry/{event_id}/results` compatible with UI**  
...
3. **Add legion data back to foundry no‑shows**  
